...
A real-time intelligence dashboard for monitoring the Middle East conflict region. WARROOM provides immediate, actionable situational awareness across military activity, geopolitical events, economic indicators, and open-source intelligence (OSINT).
...
- **AI Prediction Panel** — Predictive threat modeling using live alerts, flight data, seismic events, telegram feeds, ship movements, and thermal hotspots
...
- **Anthropic Claude Sonnet 4.6** — Cross-validation
...
### Analytics & Reporting
- **Alert Statistics Panel** — Real-time threat data with accurate live counts, 24-hour timeline, regional breakdowns, source reliability scores, and pattern detection
...
- **Warm Command Center Theme** — Information-dense UI with a warm amber/dark color palette optimized for low-light operations
...
client/                     # React frontend (Vite)
  src/
    ...
    index.css               # Global styles, CSS variables, warm command center theme
...
### Prerequisites
- Node.js 20+
- API keys for AI providers (configured via environment variables):
  - OpenAI (GPT-4.1)
