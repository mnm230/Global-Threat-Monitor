...
export function AmberHorizontal() {
  return (
    <div className="min-h-screen flex items-center justify-center p-5 font-mono text-[11px] select-none" style={{ 
      ...
      <div className="w-full max-w-[800px] h-[500px] flex flex-col gap-[3px] relative z-10" style={{
        boxShadow: "0 10px 40px -10px rgba(0,0,0,0.8), 0 0 20px rgba(245, 158, 11, 0.05)",
      }}>
        
        {/* 1. TOP STATUS BAR */}
        <div className="flex items-center justify-between px-3 h-[28px] shrink-0 rounded-[3px] border border-[rgba(245,158,11,0.2)] bg-[rgba(245,158,11,0.08)]">
          ...
          <div className="flex items-center gap-4 text-amber-400">
            ...
            <div className="flex items-center gap-1 bg-amber-500/20 px-2 py-[1px] rounded-[2px] border border-amber-500/30 text-[10px]">
              <Activity size={10} />
              <span>3 ACTIVE</span>
            </div>
          </div>
        ...
        {/* 2. ALERT STRIP (HORIZONTAL CARDS) */}
        <div className="flex flex-col gap-[3px] shrink-0">
          <div className="flex gap-[3px] h-[73px]">
            {/* Card 1 (Critical) */}
            <div className="panel flex-1 flex-row items-stretch bg-[rgba(239,68,68,0.08)] border-[rgba(239,68,68,0.3)] shadow-[0_0_10px_rgba(239,68,68,0.05)]">
              <div className="w-1.5 bg-red-500 shrink-0 shadow-[0_0_5px_rgba(239,68,68,0.8)]"></div>
              <div className="flex-1 p-2 flex items-center justify-between">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    <span className="text-red-400 font-bold text-[13px]">KIRYAT SHMONA</span>
            ...
            {/* Card 2 (Warning) */}
            <div className="panel flex-1 flex-row items-stretch bg-[rgba(245,158,11,0.05)] border-[rgba(245,158,11,0.15)]">
              <div className="w-1.5 bg-amber-500 shrink-0"></div>
              <div className="flex-1 p-2 flex items-center justify-between">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    <span className="text-amber-400 font-bold text-[13px]">METULA</span>
                ...
                <div className="flex flex-col items-end gap-1">
                  <div className="text-[16px] font-bold text-amber-500 flex items-center gap-1">
            ...
            {/* Card 3 (Warning) */}
            <div className="panel flex-1 flex-row items-stretch bg-[rgba(245,158,11,0.03)] border-[rgba(245,158,11,0.1)]">
              <div className="w-1 bg-amber-500/70 shrink-0"></div>
              <div className="flex-1 p-2 flex items-center justify-between">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    <span className="text-amber-400/80 font-bold text-[13px]">NAHARIYA</span>
                ...
                <div className="flex flex-col items-end gap-1">
                  <div className="text-[16px] font-bold text-amber-500/80 flex items-center gap-1">
          ...
          {/* SIRENS STRIP */}
          <div className="panel flex-row h-[24px] border-[rgba(239,68,68,0.2)] bg-[rgba(239,68,68,0.03)] flex items-center gap-3 px-3 shrink-0">
            <div className="flex items-center gap-2 text-red-400/80 pr-3 border-r border-red-500/20 h-full">
              <Radio size={12} className="red-pulse" />
              <span className="font-bold text-[10px]">ACTIVE SIRENS</span>
            </div>
            <div className="flex items-center gap-2 h-full py-1">
              <div className="bg-red-500/10 text-red-400 border border-red-500/30 px-2 h-full flex items-center rounded-[2px] text-[9px] gap-1.5">
                <span className="w-1 h-1 bg-red-500 rounded-full red-pulse"></span>
                GALILEY PANHANDLE
              </div>
              <div className="bg-amber-500/10 text-amber-400 border border-amber-500/30 px-2 h-full flex items-center rounded-[2px] text-[9px] gap-1.5">
        ...
        {/* 3. MAP BAND */}
        <div className="panel flex-1 h-[180px] relative overflow-hidden shrink-0">
          ...
          {/* Map Blips */}
          <div className="absolute top-[35%] left-[30%] flex items-center justify-center z-10">
            ...
            <div className="absolute top-2 left-3 text-[8px] text-red-400 bg-[hsl(222,28%,4%)] px-1 border border-red-500/30 rounded-[2px] whitespace-nowrap">IMPACT_ZONE_A</div>
          </div>
          
          <div className="absolute top-[25%] left-[70%] flex items-center justify-center z-10">
            ...
            <div className="absolute top-2 left-2 text-[8px] text-amber-400 bg-[hsl(222,28%,4%)] px-1 border border-amber-500/30 rounded-[2px] whitespace-nowrap">UAV_TRACK_01</div>
          </div>
        ...
        {/* 4. INTEL + MARKETS BAND */}
        <div className="flex gap-[3px] flex-1 min-h-0">
          {/* Left 60%: INTEL FEED */}
          <div className="panel w-[60%] border-[rgba(245,158,11,0.2)]">
            <div className="panel-header text-amber-500/80 bg-[rgba(245,158,11,0.05)] h-[28px] py-0">
              <Search size={12} />
              <span className="flex-1 text-[10px]">INTEL FEED</span>
              <span className="w-1.5 h-1.5 rounded-full bg-amber-500 amber-pulse"></span>
            </div>
            
            <div className="flex flex-col p-2 gap-2 overflow-hidden justify-center flex-1">
              <div className="flex flex-col gap-1 p-2 bg-[rgba(239,68,68,0.05)] border-l-2 border-red-500 rounded-r-[2px]">
              ...
              <div className="flex flex-col gap-1 p-2 bg-[rgba(255,255,255,0.02)] border-l-2 border-amber-500/50 rounded-r-[2px]">
                <div className="flex justify-between items-center text-[9px] text-white/40">
          ...
          {/* Right 40%: MARKETS */}
          <div className="panel w-[40%] bg-[rgba(245,158,11,0.02)] border-[rgba(245,158,11,0.1)] opacity-80">
            <div className="flex-1 flex flex-col justify-center gap-2 px-6 py-2">
              <div className="flex items-center justify-between">
                <span className="text-white/40 text-[11px]">OIL</span>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-white/40 text-[11px]">GOLD</span>
                <div className="flex items-center gap-2">
              ...
              <div className="h-[1px] bg-white/5 w-full"></div>
              <div className="flex items-center justify-between">
                <span className="text-white/40 text-[11px]">USD/ILS</span>
                <div className="flex items-center gap-2">
            ...
            <div className="h-[28px] border-t border-[rgba(245,158,11,0.1)] flex items-center justify-center gap-2 bg-[rgba(245,158,11,0.03)] shrink-0">
        ...
        {/* 5. BOTTOM BAR */}
        <div className="flex items-center justify-between px-2 h-[20px] shrink-0 text-[9px] text-amber-500/40 border-t border-[rgba(245,158,11,0.1)] mt-1">
          <div className="flex items-center gap-2">
            <Shield size={10} />
